...
class ProductEnvironment(str, Enum):
    """Define product environments."""
...
class StackConfigBaseModel(BaseModel):
    ...
    product_name: str = Field(
        ...
        description="The name of the product to which the stack belongs.",
    )
    ...
    def is_prod(self) -> bool:
        ...
        product_env = self.deployment_settings.product_environment  # pylint: disable=no-member
        return product_env == ProductEnvironment.PRODUCTION
    ...
    def tags(self) -> Dict[str, str]:
        ...
        return {
            ...
            "ben:ai:product-name": self.product_name,
